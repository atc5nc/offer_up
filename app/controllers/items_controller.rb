class ItemsController < ApplicationController
  ...
  def index
    ...
    @items = @q.result(:distinct => true).includes(:owner, :comments, :category).page(params[:page]).per(10)
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:title, :price, :photo, :location, :description, :category_id, :status, :owner_id)
    end
end
